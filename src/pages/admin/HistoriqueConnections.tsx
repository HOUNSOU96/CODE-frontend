...
const HistoriqueConnections: React.FC = () => {
  ...
  const totalOnline = useMemo(
    () => records.filter((r) => r.heure_deconnexion === "-").length,
    [records]
  );
  ...
  const filteredRecords = useMemo(() => {
    ...
    return records.filter((r) => {
      ...
      const isOnline = r.heure_deconnexion === "-";
    ...
    return Object.entries(grouped)
      ...
      .map(([date, recs]) => {
        ...
        const sorted = [...recs].sort((a, b) => {
          ...
          const aOnline = a.heure_deconnexion === "-";
          const bOnline = b.heure_deconnexion === "-";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mt-6">
        ...
        {/* Nouveau bouton pour accéder au Dashboard */}
  <button
