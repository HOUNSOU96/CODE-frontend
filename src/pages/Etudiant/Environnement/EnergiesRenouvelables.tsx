...
const EnergiesRenouvelables: React.FC = () => {
    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Explorez l'énergie solaire, éolienne, hydraulique,
          biomasse et les autres sources d'énergie renouvelable.
        </p>

        <p className="mt-3 italic font-semibold text-green-200">
          « L'énergie de demain se construit avec les ressources d'aujourd'hui. »
        </p>
      </div>
      ...
      >
        ...
        >
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            <FaSolarPanel className="text-5xl text-yellow-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Énergies propres et solutions énergétiques durables.
            </p>
          </div>
