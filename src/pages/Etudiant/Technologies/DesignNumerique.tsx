...
const DesignNumerique: React.FC = () => {
    ...
    >
      ...
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Explorez la conception graphique et numérique, la création
          d'interfaces, l'expérience utilisateur et les outils permettant
          de donner une forme visuelle aux idées.
        </p>

        <p className="mt-3 text-sm sm:text-base italic font-semibold text-blue-200">
          « Concevoir, c'est transformer une idée en expérience. »
        </p>
      ...
      >
        ...
        >
          ...
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            ...
            <FaPaintBrush className="text-5xl text-pink-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Création graphique, interfaces et expérience utilisateur.
            </p>
