    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Comprenez le fonctionnement des banques, des comptes,
          des crédits, de l'épargne et des moyens de paiement.
        </p>

        <p className="mt-3 italic font-semibold text-indigo-200">
          « Comprendre le système bancaire, c'est mieux maîtriser ses choix financiers. »
        </p>
      </div>
      ...
      >
        ...
        >
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            <FaUniversity className="text-5xl text-indigo-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Comptes, crédits, épargne et moyens de paiement.
            </p>
          </div>
      ...
      <button
        onClick={() => navigate("/domaines/finance")}
