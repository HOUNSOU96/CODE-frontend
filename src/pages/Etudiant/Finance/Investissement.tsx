    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Découvrez les principes de l'investissement, du rendement,
          du risque, de la diversification et de la constitution d'un patrimoine.
        </p>

        <p className="mt-3 italic font-semibold text-emerald-200">
          « Investir, c'est transformer une ressource présente en une possibilité future. »
        </p>
      </div>
        ...
        >
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Rendement, risque, épargne et diversification.
            </p>
          </div>
