  ...
  const apprentissages = [
    {
      name: "prise-de-vue",
      label: "PRISE DE VUE",
      description: "Réglages, exposition et techniques de prise de vue.",
    },
    {
      name: "cadrage",
      label: "CADRAGE",
      description: "Composition de l'image et organisation des éléments.",
    },
    {
      name: "lumiere",
      label: "LUMIÈRE",
      description: "Lumière naturelle, artificielle et exposition.",
    },
    {
      name: "composition-photo",
      label: "COMPOSITION",
      description: "Règles et principes de composition photographique.",
    },
    {
      name: "portrait",
      label: "PORTRAIT",
      description: "Techniques et expression dans la photographie de portrait.",
    },
    {
      name: "retouche",
      label: "RETOUCHE PHOTO",
      description: "Correction, amélioration et traitement numérique des images.",
    },
  ];
    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Apprenez à observer, capturer et construire une image
          photographique.
        </p>
        ...
        {apprentissages.map((apprentissage) => (
          ...
          >
            <motion.div
              ...
              onClick={() =>
                navigate(
                  `/evaluation?domaine=arts&apprentissage=photographie-${apprentissage.name}`
                )
              }
            ...
            >
              <div className={`${cardStyle} card-face`}>
                ...
                <FaCamera className="text-5xl mb-1 text-cyan-600" />
