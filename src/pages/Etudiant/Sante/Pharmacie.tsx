    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Découvrez les notions fondamentales relatives aux
          médicaments, à leurs formes, à leur utilisation rationnelle
          et aux principes généraux de la pharmacie.
        </p>

        <p className="mt-3 italic font-semibold text-purple-200">
          « Le bon usage du médicament participe à la protection de la santé. »
        </p>
      </div>
      ...
      >
        ...
        >
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            <FaPills className="text-5xl text-purple-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Médicaments, pharmacologie et usage rationnel.
            </p>
          </div>
