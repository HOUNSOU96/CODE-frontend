    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Explorez les connaissances fondamentales relatives au corps
          humain, aux maladies, à leur prévention et aux principes
          généraux des soins médicaux.
        </p>

        <p className="mt-3 italic font-semibold text-red-200">
          « Comprendre le corps pour mieux préserver la santé. »
        </p>
      </div>
      ...
      >
        ...
        >
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            <FaUserMd className="text-5xl text-red-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Corps humain, maladies, prévention et soins médicaux.
            </p>
          </div>
