    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Apprenez à planifier, anticiper et prendre de bonnes décisions
          grâce aux jeux de stratégie et aux défis de réflexion.
        </p>

        <p className="mt-3 italic font-semibold text-amber-200">
          « Anticiper aujourd'hui, c'est préparer sa victoire de demain. »
        </p>
      </div>
      ...
      >
        ...
        >
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            <FaTrophy className="text-5xl text-amber-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Planification, anticipation et prise de décision.
            </p>
          </div>
      ...
      <button
        onClick={() => navigate("/domaines/jeux")}
