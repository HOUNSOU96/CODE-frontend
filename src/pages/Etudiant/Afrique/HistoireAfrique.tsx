...
{ id: "afrique-antique", titre: "Afrique antique" },
{ id: "royaumes-africains", titre: "Royaumes africains" },
{ id: "empires-africains", titre: "Empires africains" },
{ id: "traite-esclavage", titre: "Traite et esclavage" },
{ id: "colonisation-afrique", titre: "Colonisation de l'Afrique" },
{ id: "independances-africaines", titre: "Indépendances africaines" },
{ id: "afrique-contemporaine", titre: "Afrique contemporaine" },
];

const HistoireAfrique: React.FC = () => {
...
HISTOIRE DE L'AFRIQUE </h2> <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
Découvrez les grandes civilisations, royaumes, empires et événements
qui ont façonné l'histoire du continent africain. </p> </div>
  ...
  <div className="flex flex-wrap justify-center gap-6 max-w-6xl">
    {apprentissages.map((item) => (
      <motion.div
        ...
        onClick={() =>
          navigate(`/evaluation/afrique/histoire-afrique/${item.id}`)
        }
      >
...
export default HistoireAfrique;
