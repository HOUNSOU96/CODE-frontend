...
{ id: "relief-afrique", titre: "Relief de l'Afrique" },
{ id: "climats-afrique", titre: "Climats africains" },
{ id: "fleuves-afrique", titre: "Fleuves et lacs africains" },
{ id: "population-afrique", titre: "Population africaine" },
{ id: "ressources-naturelles", titre: "Ressources naturelles" },
{ id: "pays-afrique", titre: "Pays et régions d'Afrique" },
{ id: "urbanisation-afrique", titre: "Urbanisation africaine" },
];

const GeographieAfrique: React.FC = () => {
...
GÉOGRAPHIE DE L'AFRIQUE </h2> <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
Étudiez les territoires, les populations, les reliefs, les climats
et les ressources du continent africain. </p> </div>
  ...
  <div className="flex flex-wrap justify-center gap-6 max-w-6xl">
    {apprentissages.map((item) => (
      <motion.div
        ...
        onClick={() =>
          navigate(`/evaluation/afrique/geographie-afrique/${item.id}`)
        }
      >
...
export default GeographieAfrique;
