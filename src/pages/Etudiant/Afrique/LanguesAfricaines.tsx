...
{ id: "fon", titre: "Fon" },
{ id: "yoruba", titre: "Yoruba" },
{ id: "haoussa", titre: "Haoussa" },
{ id: "swahili", titre: "Swahili" },
{ id: "wolof", titre: "Wolof" },
{ id: "lingala", titre: "Lingala" },
{ id: "langues-bantoues", titre: "Langues bantoues" },
{ id: "ecriture-langues-africaines", titre: "Écriture des langues africaines" },
];

const LanguesAfricaines: React.FC = () => {
...
LANGUES AFRICAINES </h2> <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
Découvrez et apprenez les langues africaines ainsi que leurs
systèmes d'écriture et leurs richesses linguistiques. </p> </div>
  ...
  <div className="flex flex-wrap justify-center gap-6 max-w-6xl">
    {apprentissages.map((item) => (
      <motion.div
        ...
        onClick={() =>
          navigate(`/evaluation/afrique/langues-africaines/${item.id}`)
        }
      >
...
export default LanguesAfricaines;
