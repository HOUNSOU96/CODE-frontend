...
const DeveloppementPersonnel: React.FC = () => {
    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Développez la connaissance de soi, la confiance en soi,
          la motivation, la discipline et les habitudes nécessaires
          à votre progression personnelle.
        </p>
      ...
      >
        ...
        >
          <div
            ...
            "
          >
            <FaBrain className="text-5xl text-pink-600 mb-1" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Commencer l'apprentissage et évaluer vos connaissances.
            </p>
          </div>
      ...
      <button
        onClick={() =>
          navigate("/domaines/developpement-humain")
        }
        className="
          mt-10 px-6 py-3
...
export default DeveloppementPersonnel;