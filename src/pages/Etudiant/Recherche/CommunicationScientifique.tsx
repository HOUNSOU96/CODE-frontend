...
const CommunicationScientifique: React.FC = () => {
    ...
    >
      ...
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Apprenez à présenter, expliquer, vulgariser et diffuser
          efficacement les résultats d'une recherche auprès de
          différents publics.
        </p>

        <p className="mt-3 italic font-semibold text-pink-200">
          « La science avance lorsqu'elle est partagée. »
        </p>
      ...
      >
        ...
        >
          ...
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            ...
            <FaComments className="text-5xl text-pink-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Présentation, vulgarisation, publication et diffusion des résultats.
            </p>
...
export default CommunicationScientifique;
