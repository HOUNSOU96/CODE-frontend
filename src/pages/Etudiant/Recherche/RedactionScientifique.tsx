...
const RedactionScientifique: React.FC = () => {
    ...
    >
      ...
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Développez les compétences nécessaires pour rédiger
          clairement des articles, mémoires, thèses, rapports et
          autres productions scientifiques.
        </p>

        <p className="mt-3 italic font-semibold text-purple-200">
          « Une découverte n'est pleinement utile que lorsqu'elle peut être comprise. »
        </p>
      ...
      >
        ...
        >
          ...
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            ...
            <FaPenFancy className="text-5xl text-purple-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Articles, mémoires, thèses, rapports et documents scientifiques.
            </p>
...
export default RedactionScientifique;
