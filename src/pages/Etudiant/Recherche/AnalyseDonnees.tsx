    ...
    >
      ...
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Apprenez à collecter, nettoyer, explorer, analyser et
          interpréter des données afin d'en extraire des informations
          utiles à la recherche.
        </p>

        <p className="mt-3 italic font-semibold text-cyan-200">
          « Les données deviennent connaissances lorsqu'elles sont correctement analysées. »
        </p>
      ...
      >
        ...
        >
          ...
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            ...
            <FaDatabase className="text-5xl text-cyan-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Collecte, traitement, exploration, visualisation et interprétation des données.
            </p>
