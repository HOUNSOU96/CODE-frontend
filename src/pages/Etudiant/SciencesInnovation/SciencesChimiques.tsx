...
const SciencesChimiques: React.FC = () => {
    ...
    >
      ...
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Étudiez la matière, les molécules, les réactions chimiques
          et les méthodes permettant de développer de nouvelles
          substances et applications.
        </p>

        <p className="mt-3 text-sm sm:text-base italic font-semibold text-purple-200">
          « Comprendre la matière, c'est comprendre une partie essentielle du monde. »
        </p>
      ...
      <div className="w-40 sm:w-44 md:w-48 h-48 perspective cursor-pointer">
        ...
        >
          ...
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            ...
            <FaFlask className="text-5xl text-purple-600 mb-1" />
            ...
            <p className="text-xs font-normal text-gray-600 dark:text-gray-300 leading-snug">
              Matière, molécules, réactions et applications chimiques.
            </p>
...
export default SciencesChimiques;