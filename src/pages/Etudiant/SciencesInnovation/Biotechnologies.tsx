...
const Biotechnologies: React.FC = () => {
    ...
    >
      ...
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Explorez l'utilisation des organismes vivants, des cellules
          et des molécules biologiques pour développer des solutions
          innovantes dans différents domaines.
        </p>

        <p className="mt-3 text-sm sm:text-base italic font-semibold text-green-200">
          « Le vivant peut devenir une source majeure d'innovation. »
        </p>
      ...
      <div className="w-40 sm:w-44 md:w-48 h-48 perspective cursor-pointer">
        ...
        >
          ...
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            ...
            <FaDna className="text-5xl text-green-600 mb-1" />
            ...
            <p className="text-xs font-normal text-gray-600 dark:text-gray-300 leading-snug">
              Biologie appliquée, génétique, cellules et innovations du vivant.
            </p>
