...
const Nanotechnologies: React.FC = () => {
    ...
    >
      ...
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Explorez la matière à l'échelle nanométrique et découvrez
          comment les propriétés de la matière peuvent être exploitées
          pour créer de nouvelles technologies.
        </p>

        <p className="mt-3 text-sm sm:text-base italic font-semibold text-cyan-200">
          « À très petite échelle, la matière révèle de nouvelles possibilités. »
        </p>
      ...
      <div className="w-40 sm:w-44 md:w-48 h-48 perspective cursor-pointer">
        ...
        >
          ...
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            ...
            <FaMicroscope className="text-5xl text-cyan-600 mb-1" />
            ...
            <p className="text-xs font-normal text-gray-600 dark:text-gray-300 leading-snug">
              Matière, structures et applications à l'échelle nanométrique.
            </p>
