...
const IngenieriePedagogique: React.FC = () => {
    ...
    >
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Apprenez à analyser les besoins, concevoir des formations,
          produire des ressources et organiser des dispositifs d'apprentissage.
        </p>

        <p className="mt-3 italic font-semibold text-orange-200">
          « Concevoir l'apprentissage, c'est construire un chemin vers la compétence. »
        </p>
      </div>
      ...
      >
        ...
        >
          <div className="card-face flex flex-col items-center justify-center gap-3 bg-white/90 dark:bg-gray-700 shadow-lg rounded-xl p-4 text-center">
            <FaProjectDiagram className="text-5xl text-orange-600" />
            ...
            <p className="text-xs text-gray-600 dark:text-gray-300">
              Conception et développement de dispositifs de formation.
            </p>
          </div>
...
export default IngenieriePedagogique;