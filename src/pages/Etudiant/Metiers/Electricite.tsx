  ...
  const sousDomaines: SousDomaine[] = [
    {
      ...
      description:
        "Conception et réalisation des installations électriques domestiques et professionnelles.",
      route: "/evaluation",
    ...
    },
    {
      ...
      titre: "CÂBLAGE",
      description:
        "Câblage, raccordement et organisation des circuits électriques.",
      route: "/evaluation",
    ...
    },
    {
      ...
      titre: "ÉCLAIRAGE",
      description:
        "Installation, fonctionnement et optimisation des systèmes d'éclairage.",
      route: "/evaluation",
    ...
    },
    {
      ...
      description:
        "Production d'électricité solaire, panneaux photovoltaïques et installations.",
      route: "/evaluation",
    ...
    },
    {
      ...
      description:
        "Diagnostic, entretien et réparation des équipements électriques.",
      route: "/evaluation",
      color: "text-blue-600",
      icon: FaTools,
    },
    {
      ...
      description:
        "Prévention des risques électriques et règles de sécurité.",
      route: "/evaluation",
      color: "text-red-600",
      icon: FaShieldAlt,
    },
    ...
    >
      ...
      <div className="text-center mb-10 max-w-5xl">
        ...
        <p className="mt-4 text-sm sm:text-base text-gray-200 max-w-3xl mx-auto">
          Découvrez les principes, techniques et règles de sécurité
          nécessaires à la réalisation et à la maintenance des installations électriques.
        </p>

        <p className="mt-3 text-sm sm:text-base italic font-semibold text-blue-200">
          « Maîtriser l'électricité, c'est savoir produire et maîtriser l'énergie. »
        </p>
      ...
      <div className="mt-10 max-w-3xl text-center text-sm sm:text-base text-gray-200">
        <p>
          <strong>CODE</strong> permet d'acquérir des compétences
          pratiques en électricité tout en intégrant les exigences de sécurité.
        </p>
      </div>
