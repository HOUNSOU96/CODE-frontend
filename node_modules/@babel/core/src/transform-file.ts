...
import type { InputOptions, ResolvedConfig } from "./config/index";
import { run } from "./transformation/index";
import type { FileResult, FileResultCallback } from "./transformation/index";
